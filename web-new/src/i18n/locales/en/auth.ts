export default {
  ...
  existingIsmartAccount: 'Existing ismart account',
  ...
  bindEmailOptional: 'Bind email (optional)',
  username: 'Username',
  ...
  registerRequiredFields: 'Username, valid phone number, and a password with at least 8 characters are required.',
