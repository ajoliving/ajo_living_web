/*
 * 主題設計 Token 定義。
 * 1. 以中等複雜度維護色彩、圓角、陰影、間距、字體與邊框 token。
 * 2. 提供三套消費者 Web 主題的語意化配置。
...
const SANS_FONT_STACK = '"Avenir Next", "PingFang TC", "Noto Sans TC", sans-serif';
const WARM_SERIF_FONT_STACK = '"Canela", "Noto Serif TC", serif';
...
export const THEME_PRESETS: Record<AppThemeName, ThemePreset> = {
  default: {
    ...
    color: buildDerivedColorTokens({
      ...
      textMuted: '96 96 104',
      border: '230 230 232',
      borderStrong: '168 129 82',
      success: '46 132 100',
      warning: '188 135 78',
      danger: '178 77 73',
    }),
    shadow: {
      soft: '0 14px 34px rgba(52, 46, 38, 0.06)',
      raised: '0 24px 56px rgba(52, 46, 38, 0.10)',
      floating: '0 30px 74px rgba(52, 46, 38, 0.14)',
    },
    font: {
  ...
  'copper-sun': {
    ...
    color: buildDerivedColorTokens({
      ...
      textMuted: '143 95 57',
      border: '231 197 155',
      borderStrong: '177 98 14',
      success: '46 132 100',
      warning: '188 135 78',
      danger: '178 77 73',
    }),
    shadow: {
      soft: '0 18px 42px rgba(126, 63, 7, 0.11)',
      raised: '0 24px 60px rgba(126, 63, 7, 0.16)',
      floating: '0 34px 80px rgba(126, 63, 7, 0.22)',
    },
    font: {
      sans: SANS_FONT_STACK,
      display: WARM_SERIF_FONT_STACK,
