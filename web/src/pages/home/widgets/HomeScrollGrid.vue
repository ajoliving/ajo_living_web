...
.scroll-grid-stage {
  ...
  border-radius: 2rem;
  background:
    radial-gradient(circle at top, rgb(255 255 255 / 0.92), transparent 38%),
    linear-gradient(180deg, rgb(var(--color-surface) / 0.98), rgb(var(--color-surface-raised) / 0.94));
...
.scroll-grid-stage__shadow {
  ...
  height: 5rem;
  border-radius: 999px;
  background: radial-gradient(circle, rgb(57 43 32 / 0.18), transparent 70%);
  transform: translateY(1.5rem) scaleX(0.88);
}

.scroll-grid-shell[data-tone='copper'] .scroll-grid-stage__aurora {
  background: radial-gradient(circle, rgb(199 154 112 / 0.36), transparent 70%);
}

.scroll-grid-shell[data-tone='slate'] .scroll-grid-stage__aurora {
  background: radial-gradient(circle, rgb(121 138 153 / 0.34), transparent 70%);
}

.scroll-grid-shell[data-tone='sage'] .scroll-grid-stage__aurora {
  background: radial-gradient(circle, rgb(129 160 139 / 0.3), transparent 70%);
}
...
.scroll-grid-tile {
  ...
  box-shadow: 0 18px 28px rgb(70 53 37 / 0.14);
  transform:
...
.scroll-grid-tile[data-tone='accent'] {
  background:
    linear-gradient(160deg, rgb(var(--color-primary) / 0.24), rgb(255 255 255 / 0.92)),
    linear-gradient(180deg, rgb(var(--color-surface) / 0.96), rgb(var(--color-surface-raised) / 0.88));
}

.scroll-grid-tile[data-tone='soft'] {
  background:
    linear-gradient(180deg, rgb(255 255 255 / 0.94), rgb(var(--color-primary-soft) / 0.48)),
    linear-gradient(180deg, rgb(var(--color-surface) / 0.96), rgb(var(--color-surface-raised) / 0.88));
}
...
.scroll-grid-tile[data-tone='neutral'] {
  background:
    linear-gradient(180deg, rgb(var(--color-surface) / 0.98), rgb(var(--color-surface-muted) / 0.9));
}
