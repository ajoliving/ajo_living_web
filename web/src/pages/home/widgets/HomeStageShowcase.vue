...
.stage-showcase {
  position: relative;
  background-image:
    radial-gradient(circle at 18% 10%, rgb(var(--color-primary) / 0.18), transparent 24%),
    radial-gradient(circle at 84% 12%, rgb(var(--color-primary-soft) / 0.22), transparent 22%),
    linear-gradient(
      to right top,
      color-mix(in srgb, rgb(var(--color-primary)) 62%, rgb(var(--color-danger)) 38%) 0%,
      color-mix(in srgb, rgb(var(--color-primary)) 52%, rgb(var(--color-primary-soft)) 48%) 10%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 70%, rgb(var(--color-surface)) 30%) 20%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 46%, rgb(var(--color-surface-muted)) 54%) 30%,
      color-mix(in srgb, rgb(var(--color-page-tint)) 72%, rgb(var(--color-surface)) 28%) 40%,
      color-mix(in srgb, rgb(var(--color-surface)) 56%, rgb(var(--color-primary)) 44%) 52%,
      color-mix(in srgb, rgb(var(--color-surface-muted)) 42%, rgb(var(--color-primary)) 58%) 62%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 20%, rgb(var(--color-success)) 80%) 74%,
      color-mix(in srgb, rgb(var(--color-success)) 42%, rgb(var(--color-surface)) 58%) 84%,
      color-mix(in srgb, rgb(var(--color-success)) 26%, rgb(var(--color-primary-soft)) 74%) 100%
    );
}

html[data-theme='dark-neutral'] .stage-showcase {
  background-image:
    radial-gradient(circle at 16% 10%, rgb(var(--color-primary) / 0.24), transparent 18%),
    radial-gradient(circle at 84% 10%, rgb(var(--color-primary-soft) / 0.24), transparent 16%),
    linear-gradient(
      to right top,
      color-mix(in srgb, rgb(var(--color-primary)) 54%, rgb(var(--color-danger)) 46%) 0%,
      color-mix(in srgb, rgb(var(--color-primary)) 44%, rgb(var(--color-primary-soft)) 56%) 10%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 72%, rgb(0 0 0) 28%) 22%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 48%, rgb(var(--color-page-tint)) 52%) 34%,
      color-mix(in srgb, rgb(var(--color-page-tint)) 76%, rgb(0 0 0) 24%) 48%,
      color-mix(in srgb, rgb(var(--color-page-tint)) 48%, rgb(var(--color-primary)) 52%) 60%,
      color-mix(in srgb, rgb(var(--color-primary)) 24%, rgb(var(--color-success)) 76%) 72%,
      color-mix(in srgb, rgb(var(--color-success)) 32%, rgb(var(--color-primary-soft)) 68%) 86%,
      color-mix(in srgb, rgb(var(--color-success)) 18%, rgb(0 0 0) 82%) 100%
    );
}

html[data-theme='default'] .stage-showcase {
  background-image:
    radial-gradient(circle at 18% 9%, rgb(var(--color-primary-soft) / 0.3), transparent 18%),
    radial-gradient(circle at 82% 11%, rgb(var(--color-primary) / 0.08), transparent 14%),
    linear-gradient(
      to right top,
      color-mix(in srgb, rgb(var(--color-primary)) 36%, rgb(var(--color-primary-soft)) 64%) 0%,
      color-mix(in srgb, rgb(var(--color-primary)) 24%, rgb(var(--color-primary-soft)) 76%) 10%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 58%, rgb(255 255 255) 42%) 22%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 28%, rgb(var(--color-surface)) 72%) 34%,
      color-mix(in srgb, rgb(var(--color-page-tint)) 44%, rgb(var(--color-surface)) 56%) 46%,
      color-mix(in srgb, rgb(var(--color-surface)) 82%, rgb(var(--color-primary)) 18%) 58%,
      color-mix(in srgb, rgb(var(--color-surface-muted)) 76%, rgb(var(--color-success)) 24%) 72%,
      color-mix(in srgb, rgb(var(--color-surface)) 66%, rgb(var(--color-success)) 34%) 86%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 32%, rgb(var(--color-surface)) 68%) 100%
    );
}
...
.spacer::before {
  ...
  height: 24rem;
  border-radius: 999px;
  background: radial-gradient(circle, rgb(var(--color-primary-soft) / 0.32), transparent 70%);
  filter: blur(18px);
  content: '';
  pointer-events: none;
}
...
.home-carousel__slide {
  ...
  box-shadow: 0 18px 36px rgb(22 24 34 / 0.18);
...
.layers {
  ...
  background-image:
    linear-gradient(
      to right top,
      color-mix(in srgb, rgb(var(--color-primary)) 18%, rgb(var(--color-surface)) 82%) 0%,
      color-mix(in srgb, rgb(var(--color-primary-soft)) 36%, rgb(var(--color-surface)) 64%) 24%,
      color-mix(in srgb, rgb(var(--color-page-tint)) 58%, rgb(var(--color-surface-muted)) 42%) 48%,
      color-mix(in srgb, rgb(var(--color-success)) 18%, rgb(var(--color-surface)) 82%) 72%,
...
.stage__shade {
  ...
  inset: 0;
  background:
    linear-gradient(180deg, rgb(7 9 16 / 0.14) 0%, rgb(7 9 16 / 0.08) 30%, rgb(7 9 16 / 0.52) 100%);
  z-index: 2;
  pointer-events: none;
}
