...
import type { PropertyListingSummaryResponse } from '@/domains/property/model';
import ServicedResidenceEditorPage from '@/pages/serviced-residences/editor/Page.vue';
import AppIcon from '@/shared/components/base/AppIcon.vue';
import { formatDate } from '@/shared/utils/format';
import { resolvePropertyPriceText, resolvePropertyPublisherRole, resolvePropertyStatus } from '@/shared/utils/property';
  ...
  <section class="management-list-page">
    ...
    <Teleport to="body">
      <Transition name="management-dialog">
        ...
        >
          <section class="management-dialog-panel management-dialog-panel--editor management-dialog-panel--serviced-editor">
            <div class="management-dialog-body management-dialog-body--editor">
              <ServicedResidenceEditorPage
                :key="editorKey"
