...
| Building resident authorization | `web-new/src/pages/building/BuildingPage.vue`, `web-new/src/pages/account/building-authorization-accept/Page.vue`, `http_service/internal/service/building_authorization_service_test.go` | Owners grant remote-door and building-notice access by phone and email from My Building; unregistered residents activate through a one-time email link, while runtime APIs enforce building and feature scope. |
